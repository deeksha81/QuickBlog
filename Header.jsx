  ...
  return (
    <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
      <div className='text-center mt-20 mb-8'>
        ...
        <div className='inline-flex items-center justify-center gap px-6 py-1.5 mb-4 border border-primary/40 bg-primary/10 rounded-full text-sm text-primary'>
        ...
        {/* ✅ Fixed Search Bar */}
        <form className='flex items-center max-w-lg w-full mx-auto border border-gray-300 bg-white rounded overflow-hidden max-sm:scale-75'>
          <input
            type="text"
          ...
          <button
            type="submit"
            className='bg-primary text-white px-6 py-2 h-full hover:scale-105 transition-all cursor-pointer'
          >
            Search
          </button>
        </form>
